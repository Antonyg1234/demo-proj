...
<section class="content">
    ...
    <div class="box">
     ...
     <div class="form-horizontal">
      <?php echo form_open('admin/config/add'); ?>
        <div class="box-body">

            <div class="form-group">
               <label class="col-sm-2 control-label">Configuration Key<span class="required">  *</span></label>
               <div class="col-sm-10">
                  <input type="text" class="form-control" id="conf_key" name="conf_key" placeholder="Configuration Key"  value="<?php echo @$_POST['conf_key']; ?>">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="conf_value" name="conf_value" placeholder="Configuration Value" value="<?php echo @$_POST['conf_value']; ?>">
