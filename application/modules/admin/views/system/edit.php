...
<section class="content">
    ...
    <div class="box">
     ...
     <div class="form-horizontal">
      <?php echo form_open_multipart('admin/system/edit/'.$id, 'id="myTemplate"', 'name="myTemplate"'); ?>
        <div class="box-body">

            <div class="form-group">
               <label class="col-sm-2 control-label">Title<span class="required">  *</span></label>
               <div class="col-sm-10">
                  <input type="text" class="form-control capitalize" id="title" name="title" placeholder="Title"  value="<?php echo $template->title; ?>" readonly="true">  
          ...
          <div class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="subject" name="subject" placeholder="Subject" value="<?php echo $template->subject; ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                <textarea id="content" name="content" placeholder="Enter your content here...."><?php echo $template->content; ?></textarea>
                </div>
            ...
            <div class="clearfix" style="margin-left: 175px;">
              ...
              <button style="width: 75px;display: inline;margin-top: 10px;" type="submit" class="btn btn-block btn-success">Edit</button>
            </div>
      </div>
