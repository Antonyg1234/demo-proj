...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="form-horizontal">
            <?php echo form_open_multipart('admin/coupon/edit/'.$id,'id="myCoupon"', 'name="myCoupon"'); ?>
            <div class="box-body">

                <div class="form-group">
                    <label class="col-sm-2 control-label">Coupon Code<span class="required">  *</span></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control " id="code" name="code" placeholder="Coupon Code"  value="<?php echo $code;?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="percent_off" name="percent_off" placeholder="Percentage-off"  value="<?php echo $percent_off;?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="quantity" name="quantity" placeholder="Quantity" value="<?php echo $coupon;?>">
                ...
                <div class="clearfix" style="margin-left: 175px;">
                    <button style="width: 75px;display: inline" class="btn btn-block btn-danger" onclick="location.href='<?php echo base_url();?>admin/coupon'" type="button" class="cancelbtn">Cancel</button>
