...
if(!empty($userData)){
	$outputHTML = '
		<div class="wrapper">
			...
			<div class="tw_box">
				...
				<p><b>Logout from <a href="'.base_url().'site/authenticate/logout">Twitter</a></b></p>';
	//Latest tweets
	if(!empty($tweets)){
	...
	$outputHTML = '<a href="'.$oauthURL.'"><img src="'.base_url().'public/assets/images/home/sign-in-with-twitter.png" alt=""/></a>';
}
?>
<?php echo $outputHTML; ?>
</body>
